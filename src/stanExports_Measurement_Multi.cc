...
#include "stanExports_Measurement_Multi.h"

RCPP_MODULE(stan_fit4Measurement_Multi_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_Measurement_Multi")
